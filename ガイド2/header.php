...
<script>
  ...
  addEventListener('load', reroots);
    ...
    <meta name="description" content="おすすめクレジットカード比較ガイドでは、様々な切り口からクレジットカードを徹底比較！年会費・ポイント還元率・発行スピードなどのカテゴリ別でわかりやすくクレジットカードを紹介。絞り込み検索やランキングで比較し、あなたに合うクレジットカードを見つけよう。">
    ...
    <header>
        ...
        <h1 class="logo__box">
            <a href="<?php echo home_url('/'); ?>">
                <img class="pc" src="<?php bloginfo('template_url'); ?>/images/nav/SVG/logo__pc__guide.png" alt="">
                <img class="sp" src="<?php bloginfo('template_url'); ?>/images/nav/SVG/logo__sp__guide.png" alt="">
            </a>
