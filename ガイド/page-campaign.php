...
<div id="container">
    ...
    <section id="fv__sub__box">
        <div class="img__wrap pc">
            <picture>
                <source type="image/webp" srcset="<?php bloginfo('template_url'); ?>/images/campaign/campaign__fv.webp">
                <img src="<?php bloginfo('template_url'); ?>/images/campaign/campaign__fv.png" alt="">
            </picture>
        </div>
        <div class="img__wrap sp">
            <picture>
                <source type="image/webp" srcset="<?php bloginfo('template_url'); ?>/images/campaign/campaign__fv__sp.webp">
