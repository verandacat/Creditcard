                ...
                <colgroup style="width:10%">
                    <colgroup style="width:30%">
                        ...
                        <tr>
                            ...
                            <td><img src="http://haircare-box.com/card/wp-content/uploads/2020/12/rakuten.png" alt=""
                                    width="90"></td>
                            <td>
                                <img style="display:inline-block"
                                    src="<?php bloginfo('template_url'); ?>/images/number/paypay.jpg" alt="" width="60"
                                    class="pay">
...
<!-- ✨💎 PC/SP -->
<div id="contents__box" style="width:100%">

    <!-- 🌹 Main Contents🌹 -->

    <section id="section__box" style="margin: auto">
        ...
        <article id="ranking__sub__items__box" class="pc">
            ...
            <div class="ranking__sub__wrap">
                ...
                <?php endif; ?>
                <?php include '/home/bighappy/xn--t8j4aa4n2hxa7duezbll2iyozhz284frwre.com/public_html/wp-content/themes/card/components/pc-ranking-args.php'; ?>
        ...
        <article id="ranking__sub__items__box" class="sp">
            ...
            <div class="ranking__sub__wrap">
                ...
                <?php include '/home/bighappy/xn--t8j4aa4n2hxa7duezbll2iyozhz284frwre.com/public_html/wp-content/themes/card/components/sp-ranking-args.php'; ?>
