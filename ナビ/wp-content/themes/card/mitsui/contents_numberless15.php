    ...
    <div id="contents">
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                ...
                <p class="right"><a href="<?php echo home_url('/'); ?>link/new_mitsui_15.php" class="prrrr bold blue"
                ...
                <p class="right bold">
                    <a href="<?php echo home_url('/'); ?>link/new_mitsui_15.php" class="prrrr blue"
                ...
                <p>
                    <a href="<?php echo home_url('/'); ?>link/new_mitsui_15.php" class="prrrr" target="_blank">
